                        ...
                        <div class="card h-100 rounded-xl-end-0 rounded-start">
                            <div class="card-body px-6">
                                <div class="px-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="fw-semi-bold text-primary"><span class="fw-bolder">29</span><span
                                                class="text-black fs-1 ms-1 fw-bolder">R$</span></h1>
                        ...
                        <div class="card h-100 rounded-xl-end-0 rounded-start">
                            <div class="card-body px-6">
                                <div class="px-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="fw-semi-bold text-primary"><span class="fw-bolder">49</span><span
                                                class="text-black fs-1 ms-1 fw-bolder">R$</span></h1>
