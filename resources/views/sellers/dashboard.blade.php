    ...
    <div class="pb-5">
        <div class="row g-4">
            <div class="col-12 col-xxl-6">
                <div class="mb-8">
                    <h2 class="mb-2">Painel do Vendedor</h2>
                    <h5 class="text-700 fw-semi-bold">Veja o que está acontecendo no seu negócio agora</h5>
                </div>
                <div class="row align-items-center g-4">
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center">
                            <img src="{{asset('assets/img/icons/illustrations/4l.png')}}" alt="" height="46" width="46" />
                            <div class="ms-3">
                                <h4 class="mb-0">57 novos pedidos</h4>
                                <p class="text-800 fs--1 mb-0">Aguardando processamento</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center">
                            <img src="{{asset('assets/img/icons/illustrations/3l.png')}}" alt="" height="46" width="46" />
                            <div class="ms-3">
                                <h4 class="mb-0">5 pedidos</h4>
                                <p class="text-800 fs--1 mb-0">Em espera</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center">
                            <img src="{{asset('assets/img/icons/illustrations/2l.png')}}" alt="" height="46" width="46" />
                            <div class="ms-3">
                                <h4 class="mb-0">15 produtos</h4>
                                <p class="text-800 fs--1 mb-0">Sem estoque</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row flex-between-center mb-4 g-3">
                    <div class="col-auto">
                        ...
                        <p class="text-700 lh-sm mb-0">Pagamentos recebidos em todos os canais</p>
                    </div>
                    <div class="col-8 col-sm-4">
                        <select class="form-select form-select-sm mt-2" id="select-gross-revenue-month">
                            <option>1º a 31 de março de 2022</option>
                            <option>1º a 30 de abril de 2022</option>
                            <option>1º a 31 de maio de 2022</option>
                        </select>
                    </div>
                </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="mb-1">Total de pedidos<span class="badge badge-phoenix badge-phoenix-warning rounded-pill fs--1 ms-2"><span class="badge-label">-6.8%</span></span></h5>
                                ...
                                <div class="mt-2">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <h6 class="text-900 fw-semi-bold flex-1 mb-0">Concluídos</h6>
                                        <h6 class="text-900 fw-semi-bold mb-0">52%</h6>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="bullet-item bg-primary-100 me-2"></div>
                                        <h6 class="text-900 fw-semi-bold flex-1 mb-0">Pagamento pendente</h6>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="mb-2">Principais cupons</h5>
                                        <h6 class="text-700">Últimos 7 dias</h6>
                                    </div>
                                </div>
                                <div class="pb-4 pt-3">
                                ...
                                <div>
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="bullet-item bg-primary me-2"></div>
                                        <h6 class="text-900 fw-semi-bold flex-1 mb-0">Desconto percentual</h6>
                                        <h6 class="text-900 fw-semi-bold mb-0">72%</h6>
                                    </div>
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="bullet-item bg-primary-200 me-2"></div>
                                        <h6 class="text-900 fw-semi-bold flex-1 mb-0">Desconto fixo por cartão</h6>
                                        <h6 class="text-900 fw-semi-bold mb-0">18%</h6>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="bullet-item bg-info-500 me-2"></div>
                                        <h6 class="text-900 fw-semi-bold flex-1 mb-0">Desconto fixo por produto</h6>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card h-100">
                            <div class="card-body d-flex flex-column">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="mb-2">Pagantes vs. não pagantes</h5>
                                        <h6 class="text-700">Últimos 7 dias</h6>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="bullet-item bg-primary me-2"></div>
                                        <h6 class="text-900 fw-semi-bold flex-1 mb-0">Cliente pagante</h6>
                                        <h6 class="text-900 fw-semi-bold mb-0">30%</h6>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="bullet-item bg-primary-100 me-2"></div>
                                        <h6 class="text-900 fw-semi-bold flex-1 mb-0">Cliente não pagante</h6>
        ...
        <div data-list='{"valueNames":["product","customer","rating","review","time"],"page":6}'>
            ...
            <div class="row align-items-center py-1">
                ...
                <div class="col d-flex fs--1">
                    ...
                    <a class="fw-semi-bold d-none" href="#!" data-list-view="less">Ver menos</a>
                </div>
                <div class="col-auto d-flex">
                    <button class="btn btn-link px-1 me-1" type="button" title="Anterior" data-list-pagination="prev"><span class="fas fa-chevron-left me-2"></span>Anterior</button>
                    <button class="btn btn-link px-1 ms-1" type="button" title="Próximo" data-list-pagination="next">Próximo<span class="fas fa-chevron-right ms-2"></span></button>
                </div>
            </div>
