                ...
                <div class="row flex-center min-vh-100 py-5">
                    <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3">
                        ...
                        <button class="btn btn-phoenix-secondary w-100 mb-3"><span
                                class="fab fa-google text-danger me-2 fs--1"></span>Registrar com o Google</button>
                        <button class="btn btn-phoenix-secondary w-100"><span
                                class="fab fa-facebook text-primary me-2 fs--1"></span>Registrar com o Facebook</button>
                        ...
                        <form action="<?php echo e(route('register')); ?>" method="POST">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control form-icon-input" name="password_confirmation"
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" id="termsService" type="checkbox"
                                    name="termsService">
                                <label class="form-label fs--1 text-none" for="termsService">Eu aceito os <a
                                        href="#!">termos</a> e a <a href="#!">política de
                                        privacidade</a></label>
                            ...
                            <div class="text-center"><a class="fs--1 fw-bold" href="{{ route('login') }}">Entrar em
                                    uma conta existente</a></div>
                        </form>
                    </div>
                </div>
            </div>
