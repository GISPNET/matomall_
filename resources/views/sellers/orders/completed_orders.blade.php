    ...
    <div class="content">
        <div class="mb-9">
            <div class="row g-3 mb-4">
                <div class="col-auto">
                    <h2 class="mb-0">Pedidos Concluídos</h2>
                </div>
            </div>
                ...
                <div
                    ...
                    <div class="row align-items-center justify-content-between py-2 pe-0 fs--1">
                        <div class="col-auto d-flex">
                          ...
                          <a class="fw-semi-bold" href="#!" data-list-view="*">Ver tudo<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
