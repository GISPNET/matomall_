<nav class="ecommerce-navbar navbar-expand navbar-light bg-white justify-content-between">
    <div class="container-small d-flex flex-between-center" data-navbar="data-navbar">
      ...
      <ul class="navbar-nav justify-content-end align-items-center">
        <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link ps-0 active" href="/">Início</a></li>
        <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link" href="apps/e-commerce/landing/favourite-stores.html">Lojas</a></li>
        <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link" href="{{ route('product.index') }}">Produtos</a></li>
        <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link" href="apps/e-commerce/landing/wishlist.html">Lista de Desejos</a></li>
        ...
        <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link" href="{{ route('seller.landing.index') }}">Vendedor</a></li>
