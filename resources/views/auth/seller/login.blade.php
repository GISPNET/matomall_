                        ...
                        <div class="col col-sm-6 col-lg-7 col-xl-6"><a
                            ...
                            <div class="text-center mb-7">
                                ...
                                <p class="text-700">Acesse sua conta</p>
                                    ...
                                    class="fab fa-google text-danger me-2 fs--1"></span>Entrar com o
                                Google</button><button class="btn btn-phoenix-secondary w-100"><span
                                    class="fab fa-facebook text-primary me-2 fs--1"></span>Entrar com o
                                Facebook</button>
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="mb-3 text-start">
                                    ...
                                    <div class="form-icon-container">
                                        <input class="form-control form-icon-input" id="email" name="email"
                                            type="email" placeholder="nome@exemplo.com" value="{{ old('name') }}">
                                        <?php if($errors->has('email')): ?>
                                        <span class="text-danger" style="font-size: 12px;"><?php echo e($errors->first('email')); ?></span>
                                        <?php endif; ?>
                                        <svg class="svg-inline--fa fa-user text-900 fs--1 form-icon" aria-hidden="true"
                                ...
                                <div class="mb-3 text-start">
                                    ...
                                    <div class="form-icon-container">
                                        ...
                                        <?php endif; ?>
                                        <svg class="svg-inline--fa fa-key text-900 fs--1 form-icon" aria-hidden="true"
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check mb-0">
                                            ...
                                            <label class="form-check-label mb-0"
                                                for="basic-checkbox">Lembrar-me</label>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <a class="fs--1 fw-semi-bold" href="{{ route('password.request') }}">Esqueceu
                                            a senha?</a>
                                    </div>
                                </div>
                            ...
                            <div class="text-center"><a class="fs--1 fw-bold" href="">Create an account</a>
                            </div>
                        </div>
                    </div>
                </div>
