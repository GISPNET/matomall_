        ...
        <div class="mb-9">
            ...
            <div class="d-flex flex-wrap flex-between-center mb-1">
                ...
                <div class="d-flex"><button class="btn pe-3 ps-0 text-900"><svg class="svg-inline--fa fa-print me-2"
                        ...
                        <!-- <span class="fas fa-print me-2"></span> Font Awesome fontawesome.com -->Print</button><button
                        class="btn px-3 text-900"><svg class="svg-inline--fa fa-arrow-rotate-left me-2" aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="arrow-rotate-left" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                            <path fill="currentColor"
                        ...
                        </svg><!-- <span class="fas fa-undo me-2"></span> Font Awesome fontawesome.com -->Refund</button>
                    <div class="dropdown"><button class="btn text-900 dropdown-toggle dropdown-caret-none ps-3 pe-0"
                            type="button" data-bs-toggle="dropdown" aria-expanded="false">More action<svg
                                class="svg-inline--fa fa-chevron-down ms-2" aria-hidden="true" focusable="false"
                            ...
                            <!-- <span class="fas fa-chevron-down ms-2"></span> Font Awesome fontawesome.com --></button>
                            ...
                            <div class="row g-4 flex-sm-column">
                                ...
                                <div class="col-6 col-sm-12 order-sm-1">
                                    ...
                                    <div class="ms-4">
                                        ...
                                        <p class="text-800 mb-0 fs--1">Vancouver, British Columbia,<br
                            ...
                            <div class="row g-4 flex-sm-column">
                                ...
                                <div class="col-6 col-sm-12">
                                    <div class="d-flex align-items-center mb-1"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" class="feather feather-package me-2"
                                            style="stroke-width:2.5;">
                                ...
                                <div class="col-6 col-sm-12">
                                    ...
                                    <div class="ms-4">
                                        <p class="text-800 fs--1 mb-0">Happy Birthday Shiniga <br>Lots of Love Buga Buga!!
                                        </p>
