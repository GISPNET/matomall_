                    ...
                    <div class="row g-5">
                        <div class="col-12 col-xl-8">
                            ...
                            <div class="dropzone dropzone-multiple p-0 mb-5" id="my-awesome-dropzone"
                                ...
                                <div class="fallback"><input name="files" type="file"
                                ...
                                <div class="dz-preview d-flex flex-wrap">
                                    <div class="border bg-white rounded-3 d-flex flex-center position-relative me-2 mb-2"
                                        style="height:80px;width:80px;"><img class="dz-image"
                                            ...
                                            data-dz-thumbnail="data-dz-thumbnail" /><a class="dz-remove text-400"
                                            href="#!" data-dz-remove="data-dz-remove"><span
                                                data-feather="x"></span></a></div>
                                </div>
                                <div class="dz-message text-600" data-dz-message="data-dz-message">Arraste sua foto aqui<span class="text-800">&nbsp;ou</span><button class="btn btn-link p-0" type="button">&nbsp;Navegar pelo dispositivo</button><br /><img class="mt-3 me-2" src="{{asset('assets/img/icons/image-icon.png') }}" width="40" alt="" /></div>
                            </div>
