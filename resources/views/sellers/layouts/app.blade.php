    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-header align-items-start border-bottom flex-column">
            <div class="pt-1 w-100 mb-6 d-flex justify-content-between align-items-start">
                <div>
                    <h5 class="mb-2 me-2 lh-sm"><span class="fas fa-palette me-2 fs-0"></span>Personalizador de Tema
                    </h5>
                    <p class="mb-0 fs--1">Explore diferentes estilos de acordo com suas preferências</p>
                </div>
                <button class="btn p-1 fw-bolder" type="button" data-bs-dismiss="offcanvas"
                    aria-label="Fechar"><span class="fas fa-times fs-0"> </span></button>
            </div>
            <button class="btn btn-phoenix-secondary w-100" data-theme-control="reset"><span
                    class="fas fa-arrows-rotate me-2 fs--2"></span>Redefinir para o padrão</button>
        </div>
        <div class="offcanvas-body scrollbar px-card" id="themeController">
            <div class="setting-panel-item mt-0">
                <h5 class="setting-panel-item-title">Esquema de Cores</h5>
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight">
                            <span class="mb-2 rounded d-block">
                                <img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('assets/img/generic/default-light.png') }}" alt="" />
                            </span>
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark">
                            <span class="mb-2 rounded d-block">
                                <img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('assets/img/generic/default-dark.png') }}" alt="" />
                            </span>
            ...
            <div class="border rounded-3 p-4 setting-panel-item bg-white">
                ...
                <p class="mb-0 text-700">Alterar direção do texto</p>
            </div>
            <div class="border rounded-3 p-4 setting-panel-item bg-white">
                <div class="d-flex justify-content-between align-items-center">
                  <h5 class="setting-panel-item-title mb-1">Chat de Suporte</h5>
                  <div class="form-check form-switch mb-0">
                    <input class="form-check-input ms-auto" id="chatSupportToggle" type="checkbox" data-theme-control="phoenixSupportChat" onchange="handleChatSupportToggle()" />
                  </div>
                </div>
                <p class="mb-0 text-700">Ativar/desativar chat de suporte</p>
              </div>
            <div class="setting-panel-item">
                <h5 class="setting-panel-item-title">Tipo de Navegação</h5>
                <div class="row gx-2">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionHorizontal">
                            <span class="mb-2 rounded d-block">
                                <img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('assets/img/generic/top-default.png') }}" alt="" />
                                <img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('assets/img/generic/top-default-dark.png') }}" alt="" />
                            </span>
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionCombo">
                            <span class="mb-2 rounded d-block">
                                <img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('assets/img/generic/nav-combo-light.png') }}" alt="" />
                                <img class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('assets/img/generic/nav-combo-dark.png') }}" alt="" />
                            </span>
            ...
            <div class="setting-panel-item">
                <h5 class="setting-panel-item-title">Aparência do Navbar Vertical</h5>
                <div class="row gx-2">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-dark">
                            <img class="img-fluid img-prototype d-dark-none"
                                src="{{ asset('assets/img/generic/vertical-darker.png') }}" alt="" />
                            <img class="img-fluid img-prototype d-light-none"
                                src="{{ asset('assets/img/generic/vertical-lighter.png') }}" alt="" />
            ...
            <div class="setting-panel-item">
                <h5 class="setting-panel-item-title">Formato do Navbar Horizontal</h5>
                <div class="row gx-2">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarShapeSlim">
                            <span class="mb-2 rounded d-block">
                                <img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('assets/img/generic/top-slim.png') }}" alt="" />
                                <img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('assets/img/generic/top-slim-dark.png') }}" alt="" />
                            </span>
            ...
            <div class="setting-panel-item">
                <h5 class="setting-panel-item-title">Aparência do Navbar Horizontal</h5>
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarTopDefault">
                            <span class="mb-2 rounded d-block">
                                <img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('assets/img/generic/top-default.png') }}" alt="" />
                                <img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('assets/img/generic/top-style-darker.png') }}" alt="" />
                            </span>
                            <span class="label-text">Default</span>
                        </label>
                    </div>
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarTopDarker">
                            <span class="mb-2 rounded d-block">
                                <img class="img-fluid img-prototype d-dark-none mb-0"
                                    ...
                                    alt="" />
                                <img class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('assets/img/generic/top-style-lighter.png') }}" alt="" />
                            </span>
                            <span class="label-text d-dark-none">Darker</span>
                            <span class="label-text d-light-none">Lighter</span>
                        </label>
